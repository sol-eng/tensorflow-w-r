...
Use `bake()` to pass the data through the new recipe. The predictor and outcome data are processed separately.  This is because how Keras expects these arguments to be used when fitting a model.
...
r <- POST("http://colorado.rstudio.com/rsc/content/1532/serving_default/predict", body = body, encode = "json")
r
